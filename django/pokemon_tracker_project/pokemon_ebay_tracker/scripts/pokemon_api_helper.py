...
def fetch_pokemon_cards(ebay_api_key):
    ...
    #     {"name": "McDonald's Collection 2014", "code": "mcd14"},
    #     {"name": "McDonald's Collection 2015", "code": "mcd15"},
    #     {"name": "McDonald's Collection 2018", "code": "mcd18"},
    #     {"name": "McDonald's Collection 2017", "code": "mcd17"},
    #     {"name": "McDonald's Collection 2021", "code": "mcd21"},
    #     {"name": "Best of Game", "code": "bp"},
    #     {"name": "Fusion Strike", "code": "swsh8"},
    #     {"name": "Pokémon Futsal Collection", "code": "fut20"},
    #     {"name": "EX Trainer Kit Latias", "code": "tk1a"},
    #     {"name": "EX Trainer Kit Latios", "code": "tk1b"},
    #     {"name": "EX Trainer Kit 2 Plusle", "code": "tk2a"},
    #     {"name": "EX Trainer Kit 2 Minun", "code": "tk2b"},
